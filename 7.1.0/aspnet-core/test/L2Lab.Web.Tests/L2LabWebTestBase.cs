...
{
    public abstract class L2LabWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static L2LabWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(L2LabWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<L2LabDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<L2LabDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<L2LabDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<L2LabDbContext, Task<T>> func)
        {
            T result;
