...
namespace L2Lab.Migrations
{
    ...
    [Migration("20220505083248_AddL2LabMessages_CriationTime_to_entity")]
    partial class AddL2LabMessages_CriationTime_to_entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("L2Lab.EntityFrameworkCore.L2LabMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("L2Lab.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("L2Lab.Authorization.Users.User", null)
                        .WithMany("Claims")
